...
type TransactionInput = Omit<Transaction, 'id' | 'createdAt'> //Transaction input irá herdar todas as props do transaction meno id e createdAt
...
//     category: string;
// }
// type TransactionInput = Pick<Transaction, 'title' | 'amount' | 'type'| 'category'> //Transaction input irá selecionar as props específicas do transaction 
